...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://postgres:Pookie10_@localhost/patientdetails" 
...
class Patient(db.Model): 
    ...
    def __init__(self, patient_id, name, age, patient_sex, blood_type, injury_type, injury_location, injury_cause, heart_rate, o2_level, attenders_code, ambulance_licenceplate):
...
def home():
    ...
    return render_template("patient_entry.html", title = "Medbridge", form=flask_form)
...
def submit():
    ...
    if request.method == "POST":
        ...
        patient = Patient(patient_id = id,name = name, age = age, patient_sex = patient_sex, blood_type = blood_type, injury_type = injury_type, injury_location = injury_location, injury_cause = injury_cause, heart_rate = heart_rate, o2_level = o2_level, attenders_code = attenders_code, ambulance_licenceplate = ambulance_licenceplate)
